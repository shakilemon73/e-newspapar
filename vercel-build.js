...
<body>
  ...
  console.log('🔧 Injecting storage cleanup script...');
...
(function() {
  try {
    ...
    indexContent = indexContent.replace('</head>', storageCleanup + '\n</head>');
    fs.writeFileSync(indexPath, indexContent);
    console.log('✅ Added storage cleanup script');
  }

  console.log('✅ Enhanced Vercel build completed successfully!');
  console.log('📦 Output directory: dist-static/');
  console.log('🔐 All admin pages ready for static deployment');
