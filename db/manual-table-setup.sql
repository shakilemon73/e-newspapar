...
INSERT INTO trending_topics (topic_name, topic_slug, mention_count, growth_percentage, trending_date)
VALUES
...
ON CONFLICT (topic_slug, trending_date) DO UPDATE SET
