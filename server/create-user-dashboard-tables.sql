...
-- INSERT INTO reading_history (user_id, article_id, last_read_at, read_count) VALUES
-- ('11111111-1111-1111-1111-111111111111', 1, NOW(), 1),
-- ('11111111-1111-1111-1111-111111111111', 2, NOW() - INTERVAL '1 day', 2)
-- ON CONFLICT (user_id, article_id) DO NOTHING;

-- INSERT INTO saved_articles (user_id, article_id, saved_at) VALUES
-- ('11111111-1111-1111-1111-111111111111', 1, NOW()),
-- ('11111111-1111-1111-1111-111111111111', 3, NOW() - INTERVAL '1 hour')
-- ON CONFLICT (user_id, article_id) DO NOTHING;