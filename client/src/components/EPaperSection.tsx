      ...
      <div className="bg-white rounded shadow-sm p-4 mb-8">
        ...
        <div className="flex flex-wrap gap-6 animate-pulse">
          <div className="w-full md:w-auto">
            <div className="h-80 w-48 bg-gray-200 rounded mx-auto"></div>
            <div className="mt-2 h-6 bg-gray-200 rounded w-32 mx-auto"></div>
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="h-6 bg-gray-200 rounded w-48 mx-auto mt-4"></div>
    ...
    return (
      <div className="bg-white rounded shadow-sm p-4 mb-8">
        <div className="flex justify-between items-center mb-4 border-b border-mid-gray pb-2">
          <h3 className="text-lg font-bold font-hind">ই-পেপার</h3>
          <Link href="/epaper">
            <a className="text-accent text-sm hover:underline">
          ...
          <div className="text-center">
            ...
            >
              <img 
                ...
                alt="আজকের ই-পেপার" 
                className="mx-auto shadow-md border border-mid-gray h-80 object-cover"
              />
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {epapers.filter(paper => paper.id !== latestEPaper.id).map((paper) => (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-2 border border-mid-gray rounded hover:bg-light transition text-sm"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <a href="#" className="block text-center">
                <div className="border border-mid-gray rounded p-2 hover:bg-light transition">
                  <img 
