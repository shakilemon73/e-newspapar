        ...
        if (teamError) {
          ...
          setTeamMembers([
            ...
            },
            {
              ...
              department: 'সম্পাদকীয়',
              bio: 'খেলাধুলা ও সংস্কৃতি বিভাগের দায়িত্বে রয়েছেন। ২০ বছরের অভিজ্ঞতা রয়েছে।',
              image_url: '/api/placeholder/150/150',
          ...
          setCompanyInfo([
            {
              ...
              section: 'mission',
              title: 'আমাদের লক্ষ্য',
              content: 'প্রথম আলোর লক্ষ্য হলো বাংলাদেশের জনগণের কাছে সত্য, নিরপেক্ষ ও সময়োপযোগী সংবাদ পৌঁছে দেওয়া। আমরা গণতান্ত্রিক মূল্যবোধ, মানবাধিকার এবং সামাজিক ন্যায়বিচারের পক্ষে কাজ করি।',
              display_order: 1,
            ...
            },
            {
              ...
              section: 'history',
              title: 'আমাদের ইতিহাস',
              content: 'প্রথম আলো ১৯৯৮ সালে প্রতিষ্ঠিত হয় এবং দ্রুত বাংলাদেশের অন্যতম জনপ্রিয় দৈনিক পত্রিকা হিসেবে স্থান করে নেয়। আমরা বাংলাদেশের গণতান্ত্রিক আন্দোলন, মুক্তিযুদ্ধের চেতনা এবং সামাজিক অগ্রগতির সাথে জড়িত থেকেছি।',
              display_order: 4,
              updated_at: new Date().toISOString()
            }
          ]);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">প্রথম আলো সম্পর্কে জানুন</p>
        </div>
