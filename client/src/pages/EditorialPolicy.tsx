          ...
          setPolicies([
            {
              ...
              content: 'প্রথম আলো সম্পূর্ণ সম্পাদকীয় স্বাধীনতায় বিশ্বাস করে। আমাদের সাংবাদিকরা কোনো বাহ্যিক চাপ বা প্রভাব ছাড়াই তাদের কাজ সম্পন্ন করেন। আমরা সত্য প্রকাশে প্রতিশ্রুতিবদ্ধ এবং কোনো রাজনৈতিক বা অর্থনৈতিক স্বার্থের কাছে মাথা নত করি না।',
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">প্রথম আলোর সম্পাদকীয় নীতি ও নির্দেশনা</p>
        </div>
