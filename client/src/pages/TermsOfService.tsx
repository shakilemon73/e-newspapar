          ...
          setTermsSections([
            {
              ...
              content: 'প্রথম আলো ওয়েবসাইট (www.prothomalo.com) ব্যবহার করে আপনি এই ব্যবহারের শর্তাবলী মেনে নিতে সম্মত হন। আপনি যদি এই শর্তাবলীর সাথে একমত না হন, তাহলে দয়া করে এই ওয়েবসাইট ব্যবহার করবেন না।\n\nএই শর্তাবলী আপনার এবং প্রথম আলোর মধ্যে একটি আইনি চুক্তি গঠন করে। আমরা যেকোনো সময় এই শর্তাবলী পরিবর্তন করার অধিকার রাখি।',
            ...
            },
            {
              ...
              content: 'প্রথম আলো ওয়েবসাইটের সকল বিষয়বস্তু, নিবন্ধ, ছবি, ভিডিও, লোগো এবং ডিজাইন প্রথম আলোর মালিকানাধীন বা লাইসেন্সপ্রাপ্ত। এই সামগ্রী কপিরাইট এবং অন্যান্য বুদ্ধিবৃত্তিক সম্পত্তি আইন দ্বারা সুরক্ষিত।\n\nআপনি পারবেন:\n• ব্যক্তিগত ব্যবহারের জন্য পড়া এবং দেখা\n• সামাজিক মাধ্যমে শেয়ার করা (সঠিক সূত্র উল্লেখ সহ)\n• উদ্ধৃতি প্রদান করা (সীমিত অংশ)\n\nআপনি পারবেন না:\n• বাণিজ্যিক উদ্দেশ্যে ব্যবহার করা\n• পুনঃপ্রকাশ বা বিতরণ করা\n• পরিবর্তন বা সম্পাদনা করা',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            প্রথম আলো ওয়েবসাইট ব্যবহারের নিয়ম ও শর্তাবলী
          </p>
        </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-gray-700">
                প্রথম আলো ওয়েবসাইট ব্যবহার করে আপনি উপরোক্ত সকল শর্তাবলীতে সম্মত হচ্ছেন। 
