        ...
        if (error) {
          ...
          setPolicySections([
            ...
            },
            {
              ...
              content: 'আমাদের ওয়েবসাইট কুকিজ এবং অনুরূপ প্রযুক্তি ব্যবহার করে:\n\n• আপনার পছন্দ মনে রাখা\n• সাইটের কর্মক্ষমতা উন্নত করা\n• ব্যবহারের পরিসংখ্যান সংগ্রহ করা\n• ব্যক্তিগতকৃত বিজ্ঞাপন প্রদান করা\n\nগুরুত্বপূর্ণ: আমরা Google AdSense এবং অন্যান্য বিজ্ঞাপন অংশীদারদের সাথে কাজ করি। তারা আপনার আগ্রহ অনুযায়ী বিজ্ঞাপন দেখানোর জন্য কুকিজ ব্যবহার করতে পারে। আপনি যেকোনো সময় আপনার ব্রাউজার সেটিংস থেকে কুকিজ নিয়ন্ত্রণ করতে পারেন।\n\nGoogle এর বিজ্ঞাপন কুকিজ সম্পর্কে আরও জানতে: https://policies.google.com/technologies/ads',
            ...
            },
            {
              ...
              content: 'আমরা আমাদের সেবার মান উন্নত করতে বিশ্বস্ত তৃতীয় পক্ষের সেবা ব্যবহার করি:\n\n• Google AdSense - বিজ্ঞাপন প্রদর্শনের জন্য\n• Google Analytics - ওয়েবসাইট পরিসংখ্যানের জন্য\n• সামাজিক মাধ্যম প্ল্যাটফর্ম - শেয়ারিং এবং এম্বেডিং\n• পেমেন্ট প্রসেসর - নিরাপদ লেনদেনের জন্য\n• ইমেইল সেবা - যোগাযোগের জন্য\n\nবিজ্ঞাপন অংশীদাররা:\nGoogle AdSense আমাদের সাইটে বিজ্ঞাপন প্রদর্শন করে এবং আপনার ব্রাউজিং অভ্যাস অনুযায়ী প্রাসঙ্গিক বিজ্ঞাপন দেখায়। Google এর গোপনীয়তা নীতি দেখুন: https://policies.google.com/privacy\n\nএই সেবাগুলির নিজস্ব গোপনীয়তা নীতি রয়েছে যা আমাদের নীতি থেকে আলাদা।',
